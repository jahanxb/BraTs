...
# Ensure each subset has a minimum number of samples
min_samples = 1000
if len(trainset1) < min_samples or len(trainset2) < min_samples:
    raise ValueError("Insufficient samples in trainset subsets")
if len(testset1) < min_samples or len(testset2) < min_samples:
    raise ValueError("Insufficient samples in testset subsets")
