...
federated_train_loader = sy.FederatedDataLoader(
    torch.utils.data.TensorDataset(trainset1, trainset1.targets).federate((bob, alice)),
    batch_size=64,
    shuffle=True
)

federated_test_loader = sy.FederatedDataLoader(
    torch.utils.data.TensorDataset(testset1, testset1.targets).federate((bob, alice)),
    batch_size=64,
    shuffle=False
)
